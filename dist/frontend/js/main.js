...
const sendMessageToServer = (userMessage) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
export const handleOutgoingChat = (userMessage) => {
    ...
    if (!userMessage || getIsResponseGenerating())
        return;
...
export const generateAPIResponse = (incomingMessageDiv, userMessage) => __awaiter(void 0, void 0, void 0, function* () {
    const textElement = incomingMessageDiv.querySelector('.text'); // Get text element
    try {
        // Fetch the response from the backend using userMessage
        const apiResponse = yield sendMessageToServer(userMessage);
...
setupEventListeners(document.querySelector(".typing-form"), document.querySelector(".chat-list"), document.querySelector("#toggle-theme-button"), document.querySelector("#delete-chat-button"), document.querySelectorAll(".suggestion-list .suggestion"));
